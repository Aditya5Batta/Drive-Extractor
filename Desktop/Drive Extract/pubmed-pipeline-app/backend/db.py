...
HeroRun         = _make_run_class  ("HeroRun",         "hero_runs")
HeroPaper       = _make_paper_class("HeroPaper",       "hero_papers",       "hero_runs")
HeroActivityLog = _make_log_class  ("HeroActivityLog", "hero_activity_logs", "hero_runs")
